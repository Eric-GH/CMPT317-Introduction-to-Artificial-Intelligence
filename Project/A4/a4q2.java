 ...
 * CMPT 317 A4
 *
 * This class is a script to execute/test the a4q2
 *
 */
...
public class a4q2 {
    ...
    /**
     * This main function will test the question a4q2
     * which the minimax search algorithm for variation 1b
     * @param args null
     */
    public static void main(String[] args){
        ...
        for (int i = 1; i < 11; i++){
            ...
            minimax_value = minimax.minimax_search_a4q2();// start search by minimax search algorithm
        ...
        for (int j=11;j<13; j++){
            ...
            minimax_value = minimax.minimax_search_a4q2();

 ...
 * CMPT 317 A4
 *
 * This class is a script to execute/test the a4q1
 *
 */
...
public class a4q1 {
    ...
    /**
     * This main function will test the question a4q1
     * which the minimax search algorithm for variation 1a
     * @param args null
     */
    public static void main(String[] args){
        ...
        for (int i = 1; i < 11; i++){
            ...
            minimax_value = minimax.minimax_search_a4q1();// start search by minimax search algorithm
        ...
        for (int j=11;j<13; j++){
            ...
            minimax_value = minimax.minimax_search_a4q1();

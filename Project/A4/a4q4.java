 ...
 * CMPT 317 A4
 *
 * This class is a script to execute/test the a4q4
 *
 */
public class a4q4 {
    a4q4(){
    ...
    /**
     * This main function will test the question a4q4
    ...
    public static void main(String[] args){
        ...
        for (int i = 1; i < 11; i++){
            ...
            minimax_value = minimax.minimax_search_a4q4();// start search by minimax search algorithm
        ...
        /**
         * This section will test larger number 11, 12
         */
        System.out.println("\n\t\t\t\tTest larger value");
        System.out.println(" Size\tMinimax Value\tBest Opening Move\tTime in Seconds");
        for (int j=11;j<13; j++){
            ...
            minimax_value = minimax.minimax_search_a4q4();
